...
export default function Result() {
	...
	return (
		<>
			...
			>
				<Text fontSize="2xl" fontWeight="bold" color={headingColor} mb={6}>
					{numScore === 0
						...
						: numScore <= 50
						? "あなたの上達の早さは並じゃない。10万人に一人の才能です。ただあの2人が1000万人に一人の才能をもっていたというだけです" //50点以下
						: numScore <= 60
						...
						: numScore <= 120
						? "天賦の才を持つ者が更にその才を全て投げ出してようやく得られる程の力！！" //120点以下
						: "仲間だお前は...オレと同じ、タイピング中毒者"}
				</Text>
