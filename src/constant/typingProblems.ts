...
export const hunterWords = [
	{ kanji: "百式観音", romaji: "hyakusik", eng: "ひゃくしきかんのん", validInputs: [] },
...
export const figureWords = [
	...
	{ kanji: "旅情を誘う", romaji: "ryojou o sasou", eng: "evokes a journey", validInputs: ["ryojou o sasou"] },
